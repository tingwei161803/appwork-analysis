...
window.PORTFOLIO = [
  ...
  // ===== Wave 3 expansion (Demo Days #13–31, founder spotlights, 2026-05) =====
  { id: 'voicetube', name: 'VoiceTube', industry: 'edtech', country: 'tw', batch: 'AW#7', year: 2013, stage: 'AW#7 (2013)', status: 'active', summary: { zh: '透過 YouTube 影片教英文的語言學習平台，月活躍用戶超過 200 萬。', en: 'English-learning platform built around curated YouTube videos with 2M+ monthly active users.' }, highlight: { zh: '曾贏得 Facebook FbStart 全球年度最佳 App。', en: 'Winner of Facebook FbStart global App of the Year.' }, sources: [{ title: 'AppWorks Founder Spotlight: VoiceTube', url: 'https://appworks.tw/founder-voicetube/' }] },
  { id: 'morningshop', name: 'MorningShop', industry: 'ecommerce', country: 'tw', batch: 'AW#4', year: 2012, stage: 'AW#4 (2012)', status: 'active', summary: { zh: '專營國際麥片的垂直電商，台灣早餐麥片線上市佔約 20%。', en: 'Vertical e-commerce for imported breakfast cereal with ~20% online market share in Taiwan.' }, highlight: { zh: '', en: '' }, sources: [{ title: 'AppWorks Founder Spotlight', url: 'https://appworks.tw/founder-morningshop/' }] },
  { id: 'jackercleaning', name: 'JackerCleaning', industry: 'proptech', country: 'tw', batch: 'AW#11', year: 2014, stage: 'AW#11 (2014)', status: 'active', summary: { zh: '潔客幫，媒合居家清潔師傅的 O2O 平台。', en: 'O2O home-cleaning marketplace matching trained professionals with households.' }, highlight: { zh: '', en: '' }, sources: [{ title: 'AppWorks Founder Spotlight', url: 'https://appworks.tw/founder-jackercleaning/' }] },
  { id: 'taxigo', name: 'TaxiGo', industry: 'mobility', country: 'tw', batch: 'AW#11', year: 2016, stage: 'AW#11 (2016)', status: 'acquired', summary: { zh: '透過 LINE/Messenger 叫車的聊天機器人平台，後與 Line Taxi 合作。', en: 'Chatbot-based ride-hailing service via LINE and Messenger; later partnered with Line Taxi.' }, highlight: { zh: '聊天機器人叫車先驅。', en: 'Pioneer of chat-based taxi hailing in Taiwan.' }, sources: [{ title: 'AppWorks Startup Spotlight', url: 'https://appworks.tw/startup-taxigo/' }] },
  { id: 'mooimom', name: 'MOOIMOM', industry: 'ecommerce', country: 'id', batch: 'AW#16', year: 2014, stage: 'AW#16 (2018)', status: 'active', summary: { zh: '印尼母嬰新零售品牌，採 OMO 與社群電商結合的 B2B2C 模式。', en: 'Indonesia mother-and-baby new-retail brand combining online, offline and community-leader B2B2C commerce.' }, highlight: { zh: '', en: '' }, sources: [{ title: 'AppWorks MOOIMOM Story', url: 'https://appworks.tw/mooimom/' }] },
  { id: 'pickone', name: 'Pickone', industry: 'proptech', country: 'tw', batch: 'AW#9', year: 2014, stage: 'AW#9 (2018)', status: 'active', summary: { zh: 'PickOne 拍咧 O2O 場地租借平台。', en: 'O2O venue-rental marketplace listing 1,500+ spaces.' }, highlight: { zh: '', en: '' }, sources: [{ title: 'Pickone Interview', url: 'https://appworks.tw/pickone-interview/' }] },
  { id: 'umbo-cv', name: 'Umbo Computer Vision', industry: 'security', country: 'tw', batch: 'AW#9', year: 2014, stage: 'AW#9 (2016)', status: 'active', summary: { zh: '以 AI 攝影機與 Aqua SmartCloud 提供自主式視訊安防解決方案。', en: 'AI-powered video security with the Aqua SmartCloud platform and SmartDome cameras.' }, highlight: { zh: 'AppWorks 領投 $2.8M 種子輪。', en: '$2.8M seed round led by AppWorks.' }, sources: [{ title: 'Umbo CV Seed', url: 'https://appworks.tw/umbo-cv-seed/' }] },
  { id: 'sudo', name: 'Sudo', industry: 'saas', country: 'tw', batch: 'AW#9', year: 2014, stage: 'AW#9 (2015)', status: 'active', summary: { zh: '面向企業的雲端 HR 服務新創。', en: 'Enterprise cloud HR services startup.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'fugle', name: 'Fugle', industry: 'fintech', country: 'tw', batch: 'AW#12', year: 2017, stage: 'AW#12 (2017)', status: 'active', summary: { zh: '台灣領先股票投資 App，半年內 GTV 突破新台幣 5 億元。', en: 'Leading Taiwan stock-investing mobile platform.' }, highlight: { zh: '完成新台幣 2,900 萬種子輪。', en: 'Raised NT$29M angel round with AppWorks support.' }, sources: [] },
  { id: 'foundi', name: 'foundi', industry: 'proptech', country: 'tw', batch: 'AW#8', year: 2014, stage: 'AW#8 (2014)', status: 'active', summary: { zh: '台灣不動產資訊平台，整合實價登錄與物件資料。', en: 'Real-estate listing and data platform from AppWorks Accelerator #8.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'twdd', name: 'TWDD', industry: 'mobility', country: 'tw', batch: 'AW#16', year: 2014, stage: 'AW#16 (2018)', status: 'active', summary: { zh: '台灣代駕，全台最大代駕服務平台。', en: 'Taiwan-leading designated-driver service, raised US$1.3M Series A with AppWorks support.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'soda-labs', name: 'Soda Labs', industry: 'hardware', country: 'tw', batch: 'AW#17', year: 2018, stage: 'AW#17 (2018)', status: 'active', summary: { zh: '硬體即服務的新創孵化器，協助打造軟硬整合產品。', en: 'Hardware-as-a-Service venture builder for integrated hardware-software products.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'harukaedu', name: 'HarukaEDU', industry: 'edtech', country: 'id', batch: null, year: 2013, stage: null, status: 'active', summary: { zh: '印尼線上高等教育平台，與大學合作推出學位課程。', en: 'Indonesian online higher-education platform partnering with universities.' }, highlight: { zh: 'AppWorks 參與 Series C。', en: 'AppWorks participated in Series C alongside SIG and GDP Venture.' }, sources: [] },
  { id: 'mobagel', name: 'MoBagel', industry: 'saas', country: 'tw', batch: 'AW#16', year: 2014, stage: 'AW#16 (2018)', status: 'active', summary: { zh: '為企業提供 No-Code AutoML 與資料科學 SaaS 平台。', en: 'No-code AutoML and data-science SaaS platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'novelship', name: 'Novelship', industry: 'ecommerce', country: 'sg', batch: 'AW#16', year: 2018, stage: 'AW#16 (2018)', status: 'active', summary: { zh: '東南亞限量運動鞋與潮流商品交易平台。', en: 'SEA sneaker and streetwear resale marketplace with authentication.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cubo-ai', name: 'Cubo AI', industry: 'hardware', country: 'tw', batch: 'AW#16', year: 2017, stage: 'AW#16 (2018)', status: 'active', summary: { zh: 'AI 智慧寶寶監視器，即時偵測嬰兒口鼻覆蓋等危險。', en: 'AI smart baby monitor that detects face-covering and other safety risks in real time.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cakeresume', name: 'CakeResume', industry: 'saas', country: 'tw', batch: 'AW#14', year: 2016, stage: 'AW#14 (2017)', status: 'active', summary: { zh: '亞洲科技人才求職平台 Cake，提供個人網頁式履歷與招聘工具。', en: 'Asia tech talent marketplace offering portfolio-style resumes and recruiter tools.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cyberbiz', name: 'CYBERBIZ', industry: 'ecommerce', country: 'tw', batch: 'AW#14', year: 2014, stage: 'AW#14 (2017)', status: 'active', summary: { zh: '整合電商平台、WMS 倉儲與 O2O 解決方案的全通路 SaaS。', en: 'Integrated commerce SaaS combining online store, WMS, and O2O solutions.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'eventxtra', name: 'EventX', industry: 'saas', country: 'hk', batch: 'AW#13', year: 2014, stage: 'AW#13 (2016)', status: 'active', summary: { zh: '香港會議活動報到管理 SaaS。', en: 'Hong Kong-based hybrid-event SaaS for check-in, lead capture and engagement.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'lawsnote', name: 'Lawsnote', industry: 'saas', country: 'tw', batch: 'AW#13', year: 2016, stage: 'AW#13 (2016)', status: 'active', summary: { zh: '七法 Lawsnote，台灣法律資料庫與 AI 法務助理平台。', en: 'Taiwan legal database and AI paralegal platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'ztore', name: 'Ztore', industry: 'ecommerce', country: 'hk', batch: 'AW#13', year: 2014, stage: 'AW#13 (2016)', status: 'active', summary: { zh: '香港當日配送線上雜貨平台。', en: 'Hong Kong online grocery with same-day delivery.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'boutir', name: 'Boutir', industry: 'ecommerce', country: 'hk', batch: 'AW#14', year: 2015, stage: 'AW#14 (2017)', status: 'active', summary: { zh: '掌舖，為社群賣家提供行動建站與訂單管理工具。', en: 'Mobile-first commerce platform for social sellers.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cloudbreakr', name: 'Cloudbreakr', industry: 'adtech', country: 'hk', batch: 'AW#14', year: 2016, stage: 'AW#14 (2017)', status: 'active', summary: { zh: '亞洲首個 KOL 智慧搜尋與排行分析平台。', en: 'Asia-first influencer discovery and ranking analytics platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'unicorn-skincare', name: 'UNICORN', industry: 'ecommerce', country: 'tw', batch: 'AW#9', year: 2014, stage: 'AW#9 (2016)', status: 'active', summary: { zh: '男性保養品牌，主打客製化體驗。', en: 'Men-focused skincare brand with personalized customer experience.' }, highlight: { zh: '年營收成長 400%。', en: '400% YoY revenue growth post-AppWorks.' }, sources: [] },
  { id: 'mighty-jaxx', name: 'Mighty Jaxx', industry: 'ecommerce', country: 'sg', batch: 'AW#21', year: 2012, stage: 'AW#21 (2020)', status: 'active', summary: { zh: '新加坡潮玩與藝術收藏品設計平台，合作品牌包含 Disney、Marvel。', en: 'Singapore designer-toy and art-collectible studio partnering with Disney, Marvel and Warner Bros.' }, highlight: { zh: '累計募資 $45M 以上。', en: 'Raised $45M+ across multiple rounds.' }, sources: [] },
  { id: 'glints', name: 'Glints', industry: 'saas', country: 'sg', batch: 'AW#20', year: 2015, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '新加坡 HR-tech，為東南亞年輕專業人才提供求職與遠端就業服務。', en: 'Singapore HR-tech platform connecting Southeast Asian talent with regional employers.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'aiello', name: 'Aiello', industry: 'ai', country: 'tw', batch: 'AW#20', year: 2019, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '飯店語音 AI 與全方位 SaaS 平台，前 Google Home 主管創立。', en: 'Hospitality voice-AI and all-in-one SaaS founded by ex-Google Home Asia lead Vic Shen.' }, highlight: { zh: '客戶含 Capella、台北萬豪等高端飯店。', en: 'Deployed in luxury hotels including Capella Taipei.' }, sources: [] },
  { id: 'lootex', name: 'Lootex', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '台灣 NFT 與遊戲虛擬資產跨鏈交易平台。', en: 'Taiwan-based NFT and gaming-asset marketplace with cross-chain support.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'poseidon-network', name: 'Poseidon Network', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '去中心化雲端儲存與運算聚合網路。', en: 'Decentralized cloud-storage and compute aggregator.' }, highlight: { zh: '兩次成功 exit 的創辦人。', en: 'Founded by an entrepreneur with two prior exits.' }, sources: [] },
  { id: 'steaker', name: 'Steaker', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '結合 AI 與加密資產管理的策略型理財平台。', en: 'AI-driven crypto asset management platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'turingcerts', name: 'TuringCerts', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2019, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '以區塊鏈發行學歷與職業證書的 SaaS 平台。', en: 'Blockchain-based credential issuance SaaS.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'pelith', name: 'Pelith', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2017, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '台灣 DeFi 開發團隊，產品包含 HakkaFinance 等鏈上工具。', en: 'Taiwan DeFi studio behind HakkaFinance and other on-chain protocols.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'fuly-ai', name: 'FULY.AI', industry: 'web3', country: 'tw', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '加密貨幣自動交易機器人與量化策略平台。', en: 'Crypto trading bot and quant strategy marketplace.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'ahead-medicine', name: 'AHEAD Medicine', industry: 'healthtech', country: 'tw', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: 'AI 醫療影像診斷新創，專注血液腫瘤與病理輔助分析。', en: 'AI medical-diagnostics for hematology and pathology decision support.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cognicept', name: 'Cognicept', industry: 'ai', country: 'sg', batch: 'AW#20', year: 2018, stage: 'AW#20 (2020)', status: 'active', summary: { zh: '新加坡機器人異常處理 SaaS。', en: 'Singapore robotics SaaS for remote intervention.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'pointree', name: 'Pointree', industry: 'web3', country: 'tw', batch: 'AW#17', year: 2017, stage: 'AW#17 (2018)', status: 'active', summary: { zh: '以區塊鏈為基礎的點數與會員 CRM 平台。', en: 'Blockchain-based loyalty points and CRM platform for retailers.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'set-sail', name: 'Set Sail', industry: 'ai', country: 'hk', batch: 'AW#17', year: 2017, stage: 'AW#17 (2018)', status: 'active', summary: { zh: '香港 AI 聊天機器人與行銷自動化 SaaS。', en: 'Hong Kong chatbot SaaS for conversational marketing automation.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'formosa-financial', name: 'Formosa Financial', industry: 'web3', country: 'tw', batch: 'AW#18', year: 2018, stage: 'AW#18 (2019)', status: 'active', summary: { zh: '為加密貨幣專案提供金庫管理與場外交易服務。', en: 'Crypto treasury management and OTC services for digital-asset projects.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'aversafe', name: 'Aversafe', industry: 'web3', country: 'vn', batch: 'AW#18', year: 2018, stage: 'AW#18 (2019)', status: 'active', summary: { zh: '越南學歷與身分文件區塊鏈驗證服務。', en: 'Vietnam-based blockchain credentialing and document verification service.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'botbot-ai', name: 'Botbot.AI', industry: 'ai', country: 'sg', batch: 'AW#18', year: 2017, stage: 'AW#18 (2019)', status: 'acquired', summary: { zh: '新加坡企業自動化對話 AI，被 6Estates 收購。', en: 'Singapore enterprise conversational-AI startup, acquired by 6Estates.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'springdel', name: 'Springdel', industry: 'saas', country: 'ca', batch: 'AW#18', year: 2017, stage: 'AW#18 (2019)', status: 'active', summary: { zh: '行動裝置與 IoT 終端設備管理 (MDM) SaaS。', en: 'Mobile device and IoT endpoint management SaaS for distributed fleets.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'triip', name: 'Triip', industry: 'travel', country: 'vn', batch: 'AW#18', year: 2014, stage: 'AW#18 (2019)', status: 'active', summary: { zh: '越南旅遊體驗平台，結合區塊鏈代幣激勵。', en: 'Vietnam travel-experiences marketplace with blockchain-based loyalty incentives.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'pikabu', name: 'Pikabu', industry: 'social', country: 'tw', batch: 'AW#18', year: 2018, stage: 'AW#18 (2019)', status: 'active', summary: { zh: 'AI 約會 App，運用個性與興趣演算法配對。', en: 'AI-powered dating app using personality and interest matching algorithms.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'beeinventor', name: 'BeeInventor', industry: 'hardware', country: 'hk', batch: 'AW#23', year: 2018, stage: 'AW#23 (Wistron #1)', status: 'active', summary: { zh: '智慧工地 IoT 安全帽與感測器解決方案。', en: 'Smart-construction IoT helmets and sensor platform improving worker safety.' }, highlight: { zh: 'Wistron Accelerator #1 校友。', en: 'Wistron Accelerator #1 alumnus.' }, sources: [] },
  { id: 'bsos', name: 'BSOS', industry: 'web3', country: 'tw', batch: 'AW#23', year: 2018, stage: 'AW#23 (Wistron #1)', status: 'active', summary: { zh: '區塊鏈供應鏈金融服務 BSOS。', en: 'Blockchain-based supply-chain finance platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: '3drens', name: '3drens', industry: 'mobility', country: 'tw', batch: 'AW#23', year: 2017, stage: 'AW#23 (Wistron #1)', status: 'active', summary: { zh: 'IoT 商用車隊管理與大數據分析平台。', en: 'IoT commercial vehicle fleet management and big-data analytics platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'vgv-media-asia', name: 'VGV Media Asia', industry: 'social', country: 'tw', batch: 'AW#27', year: 2020, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '亞洲 KOL 共創平台，串接 60 萬以上創作者。', en: 'Pan-Asian influencer co-creation platform working with 600,000+ creators.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'onmic', name: 'OnMic', industry: 'social', country: 'vn', batch: 'AW#27', year: 2021, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '越南社群語音內容平台。', en: 'Vietnam-based social-audio content platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'orbitnext', name: 'OrbitNext', industry: 'social', country: 'tw', batch: 'AW#27', year: 2021, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '為內容創作者提供知識付費與資金籌措平台。', en: 'Platform helping content creators monetize knowledge and raise capital from fans.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'flh', name: 'FLH', industry: 'hardware', country: 'tw', batch: 'AW#27', year: 2020, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '通用智慧家庭 IoT 平台。', en: 'Universal smart-home IoT platform integrating devices from multiple vendors.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'mimiland', name: 'Mimiland', industry: 'gaming', country: 'vn', batch: 'AW#27', year: 2021, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '越南 metaverse 平台，支援逾萬人同時在線。', en: 'Vietnamese metaverse product supporting 10,000+ concurrent users.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'loudio', name: 'Loudio', industry: 'social', country: 'vn', batch: 'AW#27', year: 2021, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '互動式點唱機 App，提供餐酒場景娛樂。', en: 'Interactive jukebox app for bars and social venues.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'tricuss', name: 'Tricuss', industry: 'ai', country: 'tw', batch: 'AW#27', year: 2022, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '在 LINE 與 WhatsApp 上提供 AI 助理服務。', en: 'AI assistant operating natively inside LINE and WhatsApp.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'potioneer', name: 'Potioneer', industry: 'food', country: 'global', batch: 'AW#27', year: 2021, stage: 'AW#27 (2024)', status: 'active', summary: { zh: '泰國私廚與餐飲訂位管理平台。', en: 'Thailand private-chef and hospitality booking-management platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'dataxquad', name: 'DataXquad', industry: 'ai', country: 'tw', batch: 'AW#27', year: 2022, stage: 'AW#27 (2024)', status: 'active', summary: { zh: 'AI 模型交易市集。', en: 'Marketplace for AI/ML models helping enterprises adopt machine learning faster.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'ajourney', name: 'Ajourney', industry: 'saas', country: 'sg', batch: 'AW#28', year: 2022, stage: 'AW#28 (2024)', status: 'active', summary: { zh: '新加坡企業 HR 與薪資管理 SaaS。', en: 'Singapore HR and payroll SaaS for SMEs and growing enterprises.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'event-horizon', name: 'Event Horizon', industry: 'web3', country: 'us', batch: 'AW#28', year: 2023, stage: 'AW#28 (2024)', status: 'active', summary: { zh: 'DAO 治理工具，協助組織管理鏈上提案與成員。', en: 'DAO governance tooling for on-chain proposals and members.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'quantlytica', name: 'Quantlytica', industry: 'web3', country: 'global', batch: 'AW#28', year: 2023, stage: 'AW#28 (2024)', status: 'active', summary: { zh: '加密資產管理與量化策略平台。', en: 'Crypto asset management platform with quant strategies.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'exchequer-finance', name: 'Exchequer Finance', industry: 'web3', country: 'sg', batch: 'AW#28', year: 2023, stage: 'AW#28 (2024)', status: 'active', summary: { zh: 'Token 風險管理與資產配置工具。', en: 'Token risk management and treasury allocation tools.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'jomud', name: 'Jomud', industry: 'ai', country: 'hk', batch: 'AW#28', year: 2023, stage: 'AW#28 (2024)', status: 'active', summary: { zh: 'AI 職涯諮詢與面試輔導平台。', en: 'AI career-consultation and interview coaching platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'cheko', name: 'Cheko', industry: 'edtech', country: 'ph', batch: 'AW#28', year: 2023, stage: 'AW#28 (2024)', status: 'active', summary: { zh: '菲律賓 AI 作業批改與學習輔助平台。', en: 'Philippines AI homework-assistance platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'yieldnest', name: 'YieldNest', industry: 'web3', country: 'web3', batch: 'AW#29', year: 2023, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '流動性再質押協議。', en: 'Liquid restaking protocol with risk-adjusted yield strategies.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'equitize', name: 'Equitize', industry: 'web3', country: 'sg', batch: 'AW#29', year: 2023, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '代幣化證券流動性聚合器。', en: 'Liquidity aggregator for tokenized securities and private assets.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'diab', name: 'DiaB', industry: 'healthtech', country: 'vn', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '越南慢性病預防與管理整合平台。', en: 'Vietnam integrated prevention and management platform for chronic diseases.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'moon-technologies', name: 'Moon Technologies', industry: 'healthtech', country: 'sg', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '應用 AR 進行治療性介入與診斷的醫療科技。', en: 'AR-driven therapeutic interventions and diagnostics technology.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'aone', name: 'AOne', industry: 'edtech', country: 'my', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '面向教育機構的 B2B SaaS 與金流系統。', en: 'B2B SaaS and payments tailored to education businesses.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'fondi', name: 'Fondi', industry: 'edtech', country: 'jp', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '虛擬遊學體驗 metaverse 平台。', en: 'Metaverse platform delivering virtual study-abroad experiences.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'peacom', name: 'Peacom', industry: 'saas', country: 'vn', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '在通訊平台上自動化商務流程的工具。', en: 'Tooling to automate commerce workflows on messaging platforms.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'konversi', name: 'Konversi', industry: 'saas', country: 'id', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '印尼適性 ERP 系統，協助 SME 管理營運。', en: 'Indonesia adaptive ERP system for SMEs.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'spun', name: 'SPUN', industry: 'travel', country: 'id', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: 'AI 簽證申辦服務。', en: 'AI-powered global visa application service.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'vocus', name: 'Vocus 方格子', industry: 'social', country: 'tw', batch: 'AW#29', year: 2018, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '方格子，連結創作者與粉絲的內容訂閱平台。', en: 'Creator-to-fan content subscription platform popular in Taiwan.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'kinetixpro', name: 'KinetixPro', industry: 'saas', country: 'sg', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: 'AI 工業 4.0 工作場所安全管理平台。', en: 'AI-powered Industry 4.0 platform improving workplace safety in factories.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'ecofirst', name: 'Ecofirst Technology', industry: 'climate', country: 'tw', batch: 'AW#29', year: 2022, stage: 'AW#29 (2024)', status: 'active', summary: { zh: 'AI 控制冷氣空調達成 35% 節能。', en: 'AI-driven HVAC control system delivering ~35% energy savings.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'uhoo', name: 'uHoo', industry: 'climate', country: 'sg', batch: 'AW#29', year: 2014, stage: 'AW#29 (2024)', status: 'active', summary: { zh: '室內空氣品質感測器與數據平台。', en: 'Indoor-air-quality sensor platform for offices and buildings.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'merito', name: 'Merito', industry: 'fintech', country: 'jp', batch: 'AW#30', year: 2023, stage: 'AW#30 (2025)', status: 'active', summary: { zh: '聚焦深科技公司的投資銀行服務。', en: 'Investment banking services focused on deep-tech companies in Japan.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'munshot', name: 'Munshot', industry: 'ai', country: 'us', batch: 'AW#30', year: 2023, stage: 'AW#30 (2025)', status: 'active', summary: { zh: '為對沖基金自動化研究的 AI agent 平台。', en: 'AI agent platform automating investment research for hedge funds.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'narrative-ai', name: 'NarrativeAI', industry: 'ai', country: 'hk', batch: 'AW#30', year: 2023, stage: 'AW#30 (2025)', status: 'active', summary: { zh: '時尚產業垂直 AI agent，連結設計師與供應商。', en: 'Vertical AI agent connecting fashion designers with manufacturing suppliers.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'sentimint', name: 'Sentimint', industry: 'web3', country: 'sg', batch: 'AW#30', year: 2023, stage: 'AW#30 (2025)', status: 'active', summary: { zh: '世界首個鏈上情感記憶平台。', en: "World's first on-chain emotional-memory vault for social experiences." }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'toii-games', name: 'Toii Games', industry: 'gaming', country: 'tw', batch: 'AW#30', year: 2022, stage: 'AW#30 (2025)', status: 'active', summary: { zh: 'XR 與地理位置技術的沉浸式遊戲新創。', en: 'Immersive XR and location-based gaming startup.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'hio', name: 'HIO', industry: 'healthtech', country: 'vn', batch: 'AW#30', year: 2022, stage: 'AW#30 (2025)', status: 'active', summary: { zh: '面向長者的 AI 個人化照護服務。', en: 'AI-powered personalized care services for elderly populations in Vietnam.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'alpha-story', name: 'Alpha Story', industry: 'adtech', country: 'sg', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '24/7 即時數位敘事預測與執行平台。', en: 'Platform forecasting and executing digital narratives in real time for brands.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'plandora', name: 'Plandora', industry: 'travel', country: 'sg', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI 創作者分身製作可信旅遊行程。', en: 'AI creator twins generating trusted, personalized travel plans.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'adora', name: 'Adora', industry: 'security', country: 'jp', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '保護兒少免於網路霸凌與不當接觸的 AI App。', en: 'AI safety app protecting children from cyberbullying and online predators.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'ammo', name: 'AMMO', industry: 'ai', country: 'global', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI 驅動社群管理工具。', en: 'AI-powered community management platform for online brands.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'aireco', name: 'AIRECO', industry: 'climate', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI 視覺與機械手臂回收分類系統。', en: 'AI vision and robotic-arm recycling sorter with ESG tracking.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'flyidea', name: 'FlyiDEA', industry: 'saas', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'CTO-as-a-Service 與 No-Code 開發平台。', en: 'CTO-as-a-Service and no-code development platform.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'greenbidz', name: 'GreenBidz', industry: 'climate', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI B2B 二手機械跨境競標平台。', en: 'AI-driven B2B auction marketplace for cross-border industrial machinery resale.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'farmio', name: 'Farmio', industry: 'food', country: 'sg', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI 食材供應鏈系統。', en: 'AI food-supply-chain OS automating orders and optimizing cold-chain logistics.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'heyeva', name: 'HeyEva', industry: 'ai', country: 'ph', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '娛樂產業 AI 經紀助理。', en: 'AI talent-management assistant automating scheduling and admin.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'holon-robotics', name: 'Holon Robotics', industry: 'hardware', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '無程式碼機器人作業系統。', en: 'No-code robotics OS that digitizes hands-on metal-grinding expertise.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'medvisor-ai', name: 'Medvisor AI', industry: 'healthtech', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '整合健康資料的 AI 醫生助手。', en: 'AI doctor assistant integrating health records for personalized at-home assessments.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'nunox', name: 'NunoX', industry: 'climate', country: 'tw', batch: 'AW#31', year: 2024, stage: 'AW#31 (2025)', status: 'active', summary: { zh: 'AI 紡織材料開發平台。', en: 'AI textile materials platform accelerating fabric R&D.' }, highlight: { zh: '', en: '' }, sources: [] },
  { id: 'carching', name: 'Carching', industry: 'adtech', country: 'kr', batch: 'AW#31', year: 2023, stage: 'AW#31 (2025)', status: 'active', summary: { zh: '將車輛轉為移動廣告載具的數據廣告平台。', en: 'Data-driven advertising platform turning vehicles into moving ad inventory.' }, highlight: { zh: '', en: '' }, sources: [] },
];
